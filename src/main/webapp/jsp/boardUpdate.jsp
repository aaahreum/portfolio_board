        ...
        <div class="container">
          ...
          <%@ include file="dbconn.jsp" %>
			<%
				...
				String sql="select title, name, to_char(time,'yyyy-MM-dd'), memo, filename from p_board where num=?";
				try{
          ...
          <form name="form" method="post" enctype="multipart/form-data" action="boardUpdateProcess.jsp?num=<%=num%>">
          <div class="content">
            <table>
              <tr id="tr1">
                <td id="td2">제목</td>
          ...
          <div class="btn">
            ...
            <button><a href="boardPage.jsp?num=<%=num%>">취소</a></button>
          </div>
          </form>
        </div>
      </div>
